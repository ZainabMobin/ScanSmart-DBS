...
from services.productService import scan_product,add_product
from databases.billDatabase import billDatabase
from services.productService import scan_product_barcode,update_quantity_after_scan,delete_product_after_scan
...
def admin_page():
    ...
    with st.sidebar:
        st.markdown("""
            <div style='text-align: center; border-bottom: 2px solid #0066FF; margin-bottom: 10px;'>
                <h2 style='color: #0066FF; margin: 0;margin-top:-40px;'> Menu</h2>
            </div>
        """, unsafe_allow_html=True)
    ...
    # Header
    st.markdown("""
        <h1 style="color: #0066FF;margin-top: -130px;">Smart Scan</h1>
