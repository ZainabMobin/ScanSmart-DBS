...
def loginPage():
    ...
    if st.session_state.page=="login":
        ...
        * {
        ...
        /* labels text above input fields to black */
        .stTextInput label {
            color: black !important;
            font-weight: 500;
            font-size: 14px;
    ...
    with left_col:
        ...
        <div class="left-half"> 
            ...
            <div style="position:absolute; bottom:20px; left:65px;">
                <p style="margin:0; line-height:1.5;">CS:220 Database Systems Project.</p>
                <p style="margin:0; line-height:1.5;">© 2025 ScanSmart. All rights reserved.</p>
            </div>
        </div>
        """, unsafe_allow_html=True)
